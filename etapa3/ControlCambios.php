...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $_SESSION['proyecto']['etapa3']['ControlCambios'] = $_POST;
...
$actividadesHolgura = array_filter($_SESSION['proyecto']['etapa3']['ChecklistVerificacionCritica'], function ($value, $key) {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php $key = str_replace('cumple', 'actividad', $key);?>
                                    <textarea class="input-non-editable" readonly type="text" name="<?php echo $key; ?>"><?php if (isset($_SESSION['proyecto']['etapa3']['ControlCambios'])) echo $_SESSION['proyecto']['etapa3']['ControlCambios'][$key]; else echo $actividadesPlaneadas[$key]; ?></textarea>
                            </td>
                                <td><?php $key = str_replace('actividad', 'tiempo', $key);?>
                                    <input class="input-non-editable" readonly type="text" name="<?php echo $key; ?>" value="<?php if (isset($_SESSION['proyecto']['etapa3']['ControlCambios'])) echo $_SESSION['proyecto']['etapa3']['ControlCambios'][$key]; else echo $actividadesPlaneadas[$key]; ?>"></td>
                            </td>
                                <td><?php $key = str_replace('tiempo', 'costo', $key); ?>
                                    <input class="input-editable" type="text" name="<?php echo $key; ?>" value="<?php if (isset($_SESSION['proyecto']['etapa3']['ControlCambios'])) echo $_SESSION['proyecto']['etapa3']['ControlCambios'][$key]; else echo $actividadesPlaneadas[$key]; ?>"> </td>
                                ...
                                <td><?php $key = str_replace('costo', 'responsable', $key);
                                    ...
                                    ?>
                                <td><input class="input-editable" type="text" name="<?php echo $key; ?>" value="<?php echo isset($_SESSION['proyecto']['etapa3']['ControlCambios'][$key]) ? $_SESSION['proyecto']['etapa3']['ControlCambios'][$key] : ''; ?>"></td>
                            </tr>
